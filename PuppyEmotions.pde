...
***Audio (Unable to complete. Cannot find SoundFile)
*/
...
void Eyes(){//Draws Zs on Menu screen    
  fill(black);

  if(millis()<=startMillis+80)
  {        
    fill(white);  
    ellipse((573), (379), 45, 45);//Left eye     
    
    fill(black);  
    ellipse((573), (379), 25, 25);//Left pupil    
  }
  else
  {
    startMillis=millis();
